...
5. instruct the user how to start or feed the context into the selected runtime;
6. ingest exported sessions only from known local files or explicit user-provided paths.
