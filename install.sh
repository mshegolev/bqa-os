...
REPO="github.com/mshegolev/bqa-os"
BIN_NAME="bqa"
...
info "Installing BQA-OS..."

if ! command -v go >/dev/null 2>&1; then
  fail "Go is required for this early installer. Install it first: brew install go"
fi

mkdir -p "$INSTALL_DIR"

info "Building $BIN_NAME from $REPO/cmd/bqa@main"
GOBIN="$INSTALL_DIR" go install "$REPO/cmd/bqa@main"
